...
java_name_width:
	...
	.p2align	3
map_modules:
	.byte	0x2, 0x53, 0x8b, 0x18, 0x25, 0x9d, 0xb2, 0x41, 0x98, 0xae, 0x23, 0x46, 0x30, 0xb1, 0x70, 0x4f	// module_uuid: 188b5302-9d25-41b2-98ae-234630b1704f
	...
	.xword	0	// duplicate_map
	.xword	map_aname.1	// assembly_name: Xamarin.AndroidX.Browser
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
	...
	.byte	0x65, 0x34, 0xb, 0xce, 0xf1, 0xfe, 0x94, 0x43, 0x93, 0xf4, 0x2e, 0x7e, 0x87, 0xcc, 0x97, 0x5c	// module_uuid: ce0b3465-fef1-4394-93f4-2e7e87cc975c
	...
	.byte	0x7e, 0xe0, 0xea, 0x83, 0x6f, 0x31, 0xe3, 0x43, 0x89, 0x1a, 0x8b, 0x15, 0x3, 0x73, 0xfb, 0x52	// module_uuid: 83eae07e-316f-43e3-891a-8b150373fb52
	.word	0x2	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module16_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.16	// assembly_name: GymBro
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
	...
	.byte	0xd9, 0x24, 0x6c, 0x8d, 0x5e, 0x40, 0xd8, 0x49, 0xa4, 0xa5, 0x4c, 0xa8, 0x1e, 0x49, 0x2e, 0xe4	// module_uuid: 8d6c24d9-405e-49d8-a4a5-4ca81e492ee4
	.word	0x41	// entry_count
...
map_java:
	...
	.word	0x200000d	// type_token_id
	.ascii	"crc647f35a027ffbc745e/MainActivity"	// java_name
	.zero	69	// byteCount == 34; fixedWidth == 103; returned size == 103
	.zero	1

	.word	0x10	// module_index
	.word	0x200000e	// type_token_id
	.ascii	"crc647f35a027ffbc745e/MainApplication"	// java_name
	.zero	66	// byteCount == 37; fixedWidth == 103; returned size == 103
	.zero	1
	...
	.word	0x0	// module_index
	.word	0x2000061	// type_token_id
	.ascii	"crc64f62664462a8937a9/SingleLocationListener"	// java_name
	.zero	59	// byteCount == 44; fixedWidth == 103; returned size == 103
	.zero	1
